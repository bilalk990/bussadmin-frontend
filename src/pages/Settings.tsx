...
const Settings = () => {
  ...
  const [activeTab, setActiveTab] = useState(userRole === 'super_admin' ? 'security' : 'general');
          ...
          <div className="glass-card p-4 sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              ...
              <button
                type="submit"
                disabled={isSaving}
                className={`flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg ${isSaving
          ...
          <div className="glass-card p-4 sm:p-6">
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-3 sm:space-y-4">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg ${isChangingPassword
                  ? 'bg-primary-600 cursor-not-allowed'
                  : 'bg-primary-500 hover:bg-primary-600'
                  } text-sm sm:text-base text-white transition-colors`}
              >
          ...
          <div className="w-full sm:w-64 space-y-2">
            {tabs.map((tab) => (
              <button
                ...
                className={`w-full p-3 sm:p-4 rounded-lg text-left transition-colors flex items-center gap-2 sm:gap-3 ${activeTab === tab.id
