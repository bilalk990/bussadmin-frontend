...
const FleetManagement = () => {
  ...
  const handleStatusChange = async (action: 'activate' | 'block' | 'delete' | 'maintenance' | 'backFromMaintenance') => {
    ...
    try {
      ...
      switch (action) {
        case 'activate':
          await busService.activateBus(selectedBus._id);
          break;
        case 'block':
          await busService.deactivateBus(selectedBus._id);
          break;
        case 'maintenance':
          await busService.setMaintenance(selectedBus._id);
          break;
        case 'backFromMaintenance':
          await busService.removeMaintenance(selectedBus._id);
          break;
        case 'delete':
